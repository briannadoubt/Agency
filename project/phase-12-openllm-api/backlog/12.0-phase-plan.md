...
- [ ] Users can run agent flows using Ollama with local models
- [ ] Users can connect to OpenAI API directly (no CLI required)
- [ ] Provider switching available in card run UI
- [ ] Streaming output works for HTTP providers
- [ ] Cost tracking for metered APIs
- [ ] Settings UI for configuring provider endpoints and API keys
