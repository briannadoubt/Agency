...
# 12.0 Phase Plan — OpenLLM API Support

Summary:
Add HTTP-based model provider support to Agency, enabling users to run agent flows with local models (Ollama, llama.cpp, vLLM) or cloud APIs without CLI dependencies.
...
Notes:
Phase planning document for HTTP-based model provider support.
