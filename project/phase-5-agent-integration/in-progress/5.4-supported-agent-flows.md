...
Acceptance Criteria:
- [ ] Document inputs/outputs for implement, review, research flows
- [ ] Define frontmatter changes per flow and success/failure states
- [ ] Outline how History entries are appended for each flow
- [ ] Behaviors implemented in app code and covered by tests; documentation alone is insufficient
