...
- [x] Behavior implemented in app code with regression tests; documentation alone is insufficient
...
- 2025-11-29: Implemented failure/crash/timeout handling with UI log surfacing and regression tests.
- 2025-11-29: Marked complete after code + tests merged; kept card in place per failure-handling policy.
