...
Acceptance Criteria:
- [x] Workers stream logs and progress updates to supervisor; app displays them live
- [x] Cancellation propagates: app → supervisor → worker, with confirmed termination
- [x] Endpoint cleanup verified (no leaked processes, descriptors, or launchd jobs)
- [x] Cancellation propagates cleanly; no leaked processes/descriptors after crash or cancel
...
- 2025-11-29: Wired codex backend into UI runs, hardened cancellation/cleanup, and added regression tests for streaming and resource teardown.
- 2025-11-29: Acceptance criteria satisfied in code and tests; moved to done.
