...
- 2025-11-28: Implemented AgentFlowCoordinator, log/backoff/lock stores, and regression tests enforcing frontmatter sequencing, locking, XPC payload wiring, retry, and telemetry paths.
